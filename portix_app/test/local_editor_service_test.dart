...
void main() {
  group('LocalEditorService.buildRemoteTempFileName', () {
    ...
    test(
      'same display name but different remote path yields different names',
      () {
    ...
    test(
      'same remote path but different timestamps yields different names',
      () {
        final first = LocalEditorService.buildRemoteTempFileName(
          'notes.txt',
          remotePath: '/home/a/notes.txt',
    ...
    test(
      'removes path separators and control-invalid characters from display name',
      () {
        final fileName = LocalEditorService.buildRemoteTempFileName(
