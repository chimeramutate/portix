...
const _terminalRenderDebugEnabled =
    bool.fromEnvironment('PORTIX_TERMINAL_DEBUG');
...
class RenderTerminal extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  Offset get cursorOffset {
    ...
    if (_terminal.isUsingAltBuffer) {
      ...
      final cursorLine =
          _terminal.buffer.absoluteCursorY - _terminal.buffer.scrollBack;
      yOffset = cursorLine * _painter.cellSize.height + _padding.top;
    } else {
      yOffset = _terminal.buffer.absoluteCursorY * _painter.cellSize.height +
          _lineOffset;
    }
  ...
  void _paint(PaintingContext context, Offset offset) {
    ...
    if (_terminal.isUsingAltBuffer) {
      ...
      lastLine =
          (lastLineOffset / charHeight).ceil().clamp(firstLine, maxLineIndex);
    }
  ...
  void _paintSegment(Canvas canvas, BufferSegment segment, Color color,
    ...
    if (_terminal.isUsingAltBuffer) {
      ...
      yOffset =
          (segment.line - firstLine) * _painter.cellSize.height + _padding.top;
    } else {
